describe('sign in', () => {
  ...
  it('should sign in', () => {
    ...
    cy.get('[data-testid="email-input"]').type(Cypress.env('CYPRESS_AUTOMATED_TESTING_EMAIL'))
    cy.get('[data-testid="password-input"]').type(Cypress.env('CYPRESS_AUTOMATED_TESTING_PASSWORD'))
