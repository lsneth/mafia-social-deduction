...
// These variables are safe to expose in your Expo app unless Row Level Security is disabled on your Database. https://supabase.com/docs/guides/getting-started/tutorials/with-expo-react-native
